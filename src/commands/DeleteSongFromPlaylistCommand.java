...
public class DeleteSongFromPlaylistCommand implements ICommand{
    ...
    public void invoke(List<String> tokens){
        //extract the args in deletesongfromplaylist command
        ...
        //now call the removeSong method from playlistService
        String revisedPlaylist = playlistService.removeSong(playlistId, songId);
